  ...
  return (
    <main>
      ...
      <section className="relative flex h-[80vh] min-h-[600px] items-center">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="Fundal high-tech service auto"
            layout="fill"
            objectFit="cover"
            priority // Încarcă imaginea cu prioritate
            quality={90}
          />
      ...
      <section id="despre" className="container mx-auto px-6 py-24">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
            <motion.div
                ...
                viewport={{ once: true, amount: 0.3 }}
                transition={{ duration: 0.8, ease: "easeOut" }}
                className="relative h-80 w-full rounded-2xl lg:h-[500px]"
            >
                <Image 
      ...
      <section id="contact" className="container mx-auto px-6 py-24">
        ...
        <div className="mt-16 grid max-w-4xl mx-auto grid-cols-1 gap-12 lg:grid-cols-2">
            <motion.div
                initial={{ opacity: 0, x: -50 }}
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true, amount: 0.3 }}
                ...
                <form action="#" method="POST" className="space-y-6">
                    <div>
                        ...
                        <div className="mt-1">
                            <input
                              ...
                              autoComplete="name"
                              required
                              className="block w-full rounded-md border-gray-600 bg-gray-800/50 px-4 py-3 text-white shadow-sm focus:border-[var(--primary-accent)] focus:ring-[var(--primary-accent)]"
                            />
                        </div>
                    </div>
                    <div>
                    ...
                    <div>
                        <label htmlFor="message" className="block text-sm font-medium text-gray-300">
                            Mesajul tău (opțional: model auto, serviciu dorit)
                        </label>
                        <div className="mt-1">
                            <textarea
                              name="message"
                    ...
                    <div>
                        <button
                          type="submit"
                          className="flex w-full justify-center rounded-lg bg-[var(--primary-accent)] px-8 py-3 font-semibold text-white shadow-sm transition-transform duration-300 hover:scale-105 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--primary-accent)]"
                        >
                            Trimite Solicitarea
                        </button>
                    </div>
                </form>
                 {/* --- END: FORMULAR COMPLET --- */}
            </motion.div>
            ...
            >
                <div className="relative h-60 w-full rounded-2xl lg:h-full">
                    <Image
                        src="/contact-map.png"
                ...
                {/* Poți adăuga aici și informații de contact textuale */}
                <div className="rounded-2xl border border-[var(--secondary-accent)]/30 bg-gray-900/50 p-6 text-center lg:text-left">
                  <h3 className="text-xl font-bold text-white">Date de Contact</h3>
                  <p className="mt-2 text-gray-400">
                    <strong>Adresa:</strong> Strada Mecanicilor Nr. 1, Mioveni, Argeș<br/>
                    <strong>Telefon:</strong> 0722 123 456<br/>
                    <strong>Email:</strong> contact@precisionauto.ro
                  </p>
                </div>
            </motion.div>
        </div>
